...
<!-- <script src="<?php echo e(asset('')); ?>/public/backend/common/js/dist/jquery.bootstrap-duallistbox.min.js"></script>
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
<script src="http://netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script> -->

<?php echo Form::open( ['id' => 'frmEnterpriseRegist', 'class' => 'form-horizontal','method' => 'post', 'route' => 'backend.enterprises.regist', 'enctype'=>'multipart/form-data', 'accept-charset'=>'utf-8']); ?>
          ...
          <table class="table table-bordered">
            <tbody>
              <tr>
                ...
                <td>
                  <input name="ent_name" id="ent_name" type="text" class="form-control form-control--small" value="<?php echo e(old('ent_name')); ?>">
                ...
                <td>
                  <input name="ent_login" id="ent_login" type="text" class="form-control form-control--default" value="<?php echo e(old('ent_login')); ?>">
