      ...
      <div class="container">
        ...
        <div class="row content content--import">
          <div class="col-md-12 text-center">
            <input onclick="location.href='<?php echo e(route('backend.students.import_result')); ?>'" value="本登録として取り込み開始" type="button" class="btn btn-sm btn-primary btn-mar-right">
            <input onclick="location.href='<?php echo e(route('backend.students.import_result')); ?>'" value="仮登録として取り込み開始" type="button" class="btn btn-sm btn-primary">
          </div>
        </div>
      </div>
    </section>
